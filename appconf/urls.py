...
urlpatterns = [
    ...
    url(r'^product/detail_add/$', product.product_detail_add, name='product_detail_add'),
    url(r'^product/sync/$', product.product_sync, name='product_sync'),
    url(r'^product/list/$', product.product_list, name='product_list'),
    url(r'^product/product_detail/(?P<app_name>[\w\?%&=\-_\d\.]+)/$', product.product_detail, name='product_detail'),
